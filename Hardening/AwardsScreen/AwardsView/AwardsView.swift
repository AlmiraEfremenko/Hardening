...
class AwardsView: UIView {
    ...
    private func setupLayout() {
        ...
        NSLayoutConstraint.activate([
            ...
            image.topAnchor.constraint(equalTo: stackViewImage.bottomAnchor, constant: 30),
    ...
    private func createViewForCounter() -> UIView {
        ...
        view.layer.borderColor = UIColor(red: 0/255.0, green: 84.0/150.0, blue: 255.0/255.0, alpha: 1.0).cgColor
